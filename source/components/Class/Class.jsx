        ...
        return(
            <div>
                ...
                <Container className="questionSection">
                    ...
                    <TextArea value={this.state.studentQuestion} className="question" placeholder='Your Question Here...' autoHeight rows={3} onChange={(event,data) => this.setState({question: data.value})}/>
                    <br></br>
